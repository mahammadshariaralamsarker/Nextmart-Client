...
export default function CartProductCard({ product }: { product: CartProduct }) {
  ...
  const handleProductQuantityIncrement = (id: string) => {
    dispatch(incrementOrderQuantity(id));
  };
  const handleProductQuantityDecrement = (id: string) => {
      ...
      <div className="flex flex-col justify-between flex-grow">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              onClick={() => handleProductQuantityDecrement(product._id)}
              variant="outline"
            ...
            <Button
              onClick={() => handleProductQuantityIncrement(product._id)}
              variant="outline"
              className="size-8 rounded-sm"
            >
              <Plus />
